// I modified some of the code I found in a tutorial for saving urls (I save workouts instead)
...
//working version: function showQRCode(urlObj, options) {
...
function showQRCodeN(urlObj, options) {
...
function getMyUrls() {
  ...
  if (storedUrls) {
    ...
    // Initialize defaults
    myUrls = [encodeURIComponent("Wednesday Walked 60 minutes "), encodeURIComponent("Thursday Elliptical 60 minutes + walked 3 miles")];
